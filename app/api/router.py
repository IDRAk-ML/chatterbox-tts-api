...
from app.api.endpoints import speech, health, models, memory, config, status, voices, long_text, websocket
...
api_router.include_router(websocket.router, tags=["WebSocket Streaming"])
